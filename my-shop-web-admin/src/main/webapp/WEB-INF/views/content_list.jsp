                ...
                <div class="col-xs-12">
                    ...
                    <div class="box box-info box-info-search" style="display: none;">
                        ...
                        <div class="box-footer">
                            <button type="button" class="btn btn-info pull-right" onclick="searchContent();">搜索</button>
                        </div>
                        <!-- /.box-footer -->
                    </div>
                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <a style="margin-left: 10px;margin-top: 10px;" href="/content/form" type="button"
                                       class="btn btn-sm btn-default"><i class="fa fa-fw fa-plus"></i>新增</a>
                                    <button onclick="App.deleteMulti('/content/delete','')"
            ...
            },
            {
                "data": function (row, type, val, meta) {
                    ...
                    return '<button type="button" class="btn btn-sm btn-default" onclick="App.showDetail(\'' + url + '\');"> <i class="fa fa-search"></i> 查看</button>&nbsp;&nbsp;&nbsp;' +
                        ...
                        '<a onclick="App.deleteMulti(\'/content/delete\',\'' + row.id + '\')" type="button" class="btn btn-sm btn-danger"><i class="fa fa-trash-o"></i> 删除</a>'
                }
            }
        ];
